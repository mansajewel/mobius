...
with tab1:
    ...
    # Hardcoded to match validated pipeline results
...
with tab4:
    ...
    # Hardcoded backtest results to match validated pipeline (176 holdout bankruptcies)
    n_total  = 176
    n_red_b  = 132   # 75.0% caught in RED
    n_yel_b  = 28    # 15.9% caught in YELLOW
    n_miss   = 16    # 9.1% missed in GREEN
    sys_rec  = 90.9
    sl       = stoplight_counts(prob, y_test, yt, rt)  # still used for zone charts
